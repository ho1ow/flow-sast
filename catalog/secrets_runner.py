...
def catalog_secrets(repo_path: str, run_id: str = "local", secrets_cfg: dict = None) -> dict:
    """Run Gitleaks and output findings directly."""
    ...
    # Try Gitleaks first
    gitleaks_findings = _run_gitleaks(repo_path, secrets_cfg, run_id, audit_dir)
