...
from connect.joern_client import JoernClient
...
def joern_pre_filter(repo_path: str, prioritized: List[dict], run_id: str = "local", joern_cfg: dict = None) -> dict:
    """Joern CFG-aware taint confirm + PathDecision routing."""
    if joern_cfg is None:
        joern_cfg = {}
